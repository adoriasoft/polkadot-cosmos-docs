...
[7. Pallet subscription](#Pallet-subscription)<br>
[8. Demo application](#Demo-application)<br>
[9. Versions](#Versions)<br>
[10. User-guides](#User-guides)<br>
...
**BlockParams**
- `max_bytes` - an equvalent of Substrate [MaximumBlockLength](https://substrate.dev/rustdocs/v2.0.0/frame_system/trait.Trait.html#associatedtype.MaximumBlockLength)
...
`max_bytes` - these parameters are related to slashing mechnism and will be analyzed later.
